...
let test file_contents =
  ...
  Ref.set_temporarily Loc.include_sexp_of_locs true ~f:(fun () ->
    List.iter crs ~f:(fun t ->
      ...
      print_dyn
        (Dyn.record
           [ "raw", t |> Cr_comment.to_dyn; "getters", getters |> Getters.to_dyn ]);
      ()))
;;
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:2:0" }
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:3:0" }
        ; content_start_offset = 3
    ...
    { raw =
        ...
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:1:2"; stop = "my_file.ml:1:4" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:1:2"; stop = "my_file.ml:1:4" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:5"; stop = "my_file.ml:1:9" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        ...
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:1:1"; stop = "my_file.ml:1:3" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:1:1"; stop = "my_file.ml:1:3" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:4"; stop = "my_file.ml:1:8" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "#"
    ...
    { raw =
        ...
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:1:4"; stop = "my_file.ml:1:6" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:1:4"; stop = "my_file.ml:1:6" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:7"; stop = "my_file.ml:1:11" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        ...
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:1:3"; stop = "my_file.ml:1:5" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:1:3"; stop = "my_file.ml:1:5" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:6"; stop = "my_file.ml:1:10" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:1:29" }
        ; content_start_offset = 3
        ; header =
            Ok
              { status =
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:11"; stop = "my_file.ml:1:15" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:3:0"; stop = "my_file.ml:3:32" }
        ; content_start_offset = 45
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:3:3"; stop = "my_file.ml:3:5" }
                  }
              ; qualifier =
                  { txt = Someday
                  ; loc = { start = "my_file.ml:3:6"; stop = "my_file.ml:3:13" }
                  }
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:3:14"; stop = "my_file.ml:3:18" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:5:0"; stop = "my_file.ml:5:40" }
        ; content_start_offset = 90
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:5:3"; stop = "my_file.ml:5:5" }
                  }
              ; qualifier =
                  { txt = Soon
                  ; loc = { start = "my_file.ml:5:6"; stop = "my_file.ml:5:10" }
                  }
              ; reporter =
                  { txt = "user1"
                  ; loc = { start = "my_file.ml:5:11"; stop = "my_file.ml:5:16" }
                  }
              ; recipient =
                  Some
                    { txt = "user2"
                    ; loc =
                        { start = "my_file.ml:5:21"; stop = "my_file.ml:5:26" }
                    }
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:7:0"; stop = "my_file.ml:7:43" }
        ; content_start_offset = 143
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:7:3"; stop = "my_file.ml:7:5" }
                  }
              ; qualifier =
                  { txt = Someday
                  ; loc = { start = "my_file.ml:7:6"; stop = "my_file.ml:7:13" }
                  }
              ; reporter =
                  { txt = "user1"
                  ; loc = { start = "my_file.ml:7:14"; stop = "my_file.ml:7:19" }
                  }
              ; recipient =
                  Some
                    { txt = "user2"
                    ; loc =
                        { start = "my_file.ml:7:24"; stop = "my_file.ml:7:29" }
                    }
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:9:0"; stop = "my_file.ml:9:30" }
        ; content_start_offset = 199
        ; header =
            Ok
              { status =
                  { txt = XCR
                  ; loc = { start = "my_file.ml:9:3"; stop = "my_file.ml:9:6" }
                  }
              ; qualifier =
                  { txt = Soon
                  ; loc = { start = "my_file.ml:9:7"; stop = "my_file.ml:9:11" }
                  }
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:9:12"; stop = "my_file.ml:9:16" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:11:0"; stop = "my_file.ml:11:33" }
        ; content_start_offset = 242
        ; header =
            Ok
              { status =
                  { txt = XCR
                  ; loc = { start = "my_file.ml:11:3"; stop = "my_file.ml:11:6" }
                  }
              ; qualifier =
                  { txt = Someday
                  ; loc =
                      { start = "my_file.ml:11:7"; stop = "my_file.ml:11:14" }
                  }
              ; reporter =
                  { txt = "user"
                  ; loc =
                      { start = "my_file.ml:11:15"; stop = "my_file.ml:11:19" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:1:77" }
        ; content_start_offset = 3
        ; header =
            Error
              ("Invalid CR comment",
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:4:0"; stop = "my_file.ml:4:47" }
        ; content_start_offset = 94
        ; header =
            Error
              ("Invalid CR comment", "CR-20260131 user: This is not it either..")
        ; comment_prefix = "(*"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:7:0"; stop = "my_file.ml:7:75" }
        ...
        ; header =
            Ok
              ...
              ; qualifier =
                  { txt = Someday
                  ; loc = { start = "my_file.ml:7:6"; stop = "my_file.ml:7:12" }
                  }
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:7:13"; stop = "my_file.ml:7:17" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:1:25" }
        ; content_start_offset = 3
        ; header =
            Ok
              { status =
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:38"; stop = "my_file.ml:1:73" }
        ; content_start_offset = 41
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:1:41"; stop = "my_file.ml:1:43" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:1:41"; stop = "my_file.ml:1:43" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:44"; stop = "my_file.ml:1:48" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:1:33" }
        ; content_start_offset = 3
        ; header =
            Ok
              { status =
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:3:0"; stop = "my_file.ml:6:0" }
        ; content_start_offset = 38
        ; header =
            Ok
              { status =
                  { txt = XCR
                  ; loc = { start = "my_file.ml:3:3"; stop = "my_file.ml:3:6" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:3:3"; stop = "my_file.ml:3:6" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:3:7"; stop = "my_file.ml:3:11" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "/*"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:1:42" }
        ; content_start_offset = 3
        ; header =
            Ok
              { status =
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:3:0"; stop = "my_file.ml:5:0" }
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:3:0"; stop = "my_file.ml:4:26" }
        ; content_start_offset = 33
        ; header =
            Ok
              { status =
                  { txt = XCR
                  ; loc = { start = "my_file.ml:3:2"; stop = "my_file.ml:3:5" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:3:2"; stop = "my_file.ml:3:5" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:3:6"; stop = "my_file.ml:3:10" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "#"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:6:11"; stop = "my_file.ml:6:67" }
        ; content_start_offset = 95
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:6:13"; stop = "my_file.ml:6:15" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:6:13"; stop = "my_file.ml:6:15" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:6:16"; stop = "my_file.ml:6:20" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "#"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:8:2"; stop = "my_file.ml:12:0" }
        ; content_start_offset = 155
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:8:4"; stop = "my_file.ml:8:6" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:8:4"; stop = "my_file.ml:8:6" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:8:7"; stop = "my_file.ml:8:11" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "#"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:1:30" }
        ; content_start_offset = 3
        ; header =
            Ok
              { status =
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:3:0"; stop = "my_file.ml:4:27" }
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:6:11"; stop = "my_file.ml:6:68" }
        ; content_start_offset = 99
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:6:14"; stop = "my_file.ml:6:16" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:6:14"; stop = "my_file.ml:6:16" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:6:17"; stop = "my_file.ml:6:21" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "##"
    ...
    { raw =
        ...
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:8:5"; stop = "my_file.ml:8:7" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:8:5"; stop = "my_file.ml:8:7" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:8:8"; stop = "my_file.ml:8:12" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "##"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:6"; stop = "my_file.ml:3:0" }
        ; content_start_offset = 9
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:1:9"; stop = "my_file.ml:1:11" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:1:9"; stop = "my_file.ml:1:11" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:12"; stop = "my_file.ml:1:16" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "##"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:6:11"; stop = "my_file.ml:7:0" }
        ; content_start_offset = 99
        ; header =
            Ok
              { status =
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:6:20"; stop = "my_file.ml:6:76" }
        ; content_start_offset = 104
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:6:22"; stop = "my_file.ml:6:24" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:6:22"; stop = "my_file.ml:6:24" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:6:25"; stop = "my_file.ml:6:29" }
                  }
              ; recipient = None
              }
        ; comment_prefix = ";"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:8:9"; stop = "my_file.ml:9:21" }
        ; content_start_offset = 190
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:8:11"; stop = "my_file.ml:8:13" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:8:11"; stop = "my_file.ml:8:13" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:8:14"; stop = "my_file.ml:8:18" }
                  }
              ; recipient = None
              }
        ; comment_prefix = ";"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:11:2"; stop = "my_file.ml:15:0" }
        ; content_start_offset = 252
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:11:4"; stop = "my_file.ml:11:6" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:11:4"; stop = "my_file.ml:11:6" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc =
                      { start = "my_file.ml:11:7"; stop = "my_file.ml:11:11" }
                  }
              ; recipient = None
              }
        ; comment_prefix = ";"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:6:20"; stop = "my_file.ml:6:77" }
        ; content_start_offset = 108
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:6:23"; stop = "my_file.ml:6:25" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:6:23"; stop = "my_file.ml:6:25" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:6:26"; stop = "my_file.ml:6:30" }
                  }
              ; recipient = None
              }
        ; comment_prefix = ";;"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:8:9"; stop = "my_file.ml:9:22" }
        ; content_start_offset = 195
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:8:12"; stop = "my_file.ml:8:14" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:8:12"; stop = "my_file.ml:8:14" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:8:15"; stop = "my_file.ml:8:19" }
                  }
              ; recipient = None
              }
        ; comment_prefix = ";;"
    ...
    { raw =
        ...
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:11:5"; stop = "my_file.ml:11:7" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:11:5"; stop = "my_file.ml:11:7" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc =
                      { start = "my_file.ml:11:8"; stop = "my_file.ml:11:12" }
                  }
              ; recipient = None
              }
        ; comment_prefix = ";;"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:1:36" }
        ; content_start_offset = 5
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:1:5"; stop = "my_file.ml:1:7" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:1:5"; stop = "my_file.ml:1:7" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:1:8"; stop = "my_file.ml:1:12" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "<!--"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:3:0"; stop = "my_file.ml:4:33" }
        ; content_start_offset = 43
        ; header =
            Ok
              { status =
                  { txt = XCR
                  ; loc = { start = "my_file.ml:3:5"; stop = "my_file.ml:3:8" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:3:5"; stop = "my_file.ml:3:8" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:3:9"; stop = "my_file.ml:3:13" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "<!--"
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:7:2"; stop = "my_file.ml:7:50" }
        ; content_start_offset = 126
        ; header =
            Ok
              { status =
                  { txt = XCR
                  ; loc = { start = "my_file.ml:7:7"; stop = "my_file.ml:7:10" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:7:7"; stop = "my_file.ml:7:10" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:7:11"; stop = "my_file.ml:7:15" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "<!--"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:3:3"; stop = "my_file.ml:3:74" }
        ; content_start_offset = 25
        ; header =
            Ok
              { status =
                  { txt = XCR
                  ; loc = { start = "my_file.ml:3:6"; stop = "my_file.ml:3:9" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:3:6"; stop = "my_file.ml:3:9" }
              ...
              ; reporter =
                  { txt = "user"
                  ; loc = { start = "my_file.ml:3:10"; stop = "my_file.ml:3:14" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:0"; stop = "my_file.ml:6:0" }
        ; content_start_offset = 3
        ; header =
            Ok
              { status =
...
|};
  [%expect
    ...
    { raw =
        { path = "my_file.ml"
        ; whole_loc = { start = "my_file.ml:1:3"; stop = "my_file.ml:1:76" }
        ; content_start_offset = 5
        ; header =
            Ok
              { status =
    ...
    { raw =
        ...
        ; header =
            Ok
              ...
              ; reporter =
                  { txt = "user1"
                  ; loc = { start = "my_file.ml:1:7"; stop = "my_file.ml:1:12" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(**"
    ...
    { raw =
        ...
        ; header =
            Ok
              ...
              ; reporter =
                  { txt = "user1"
                  ; loc = { start = "my_file.ml:1:6"; stop = "my_file.ml:1:11" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
    ...
    { raw =
        ...
        ; header =
            Ok
              { status =
                  { txt = CR
                  ; loc = { start = "my_file.ml:2:5"; stop = "my_file.ml:2:7" }
                  }
              ; qualifier =
                  { txt = None
                  ; loc = { start = "my_file.ml:2:5"; stop = "my_file.ml:2:7" }
              ...
              ; reporter =
                  { txt = "user1"
                  ; loc = { start = "my_file.ml:2:8"; stop = "my_file.ml:2:13" }
                  }
              ; recipient = None
              }
        ; comment_prefix = "(*"
