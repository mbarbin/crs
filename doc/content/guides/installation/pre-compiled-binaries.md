...
> **Note:** If your architecture is not listed, you'll need to use the [opam installation method](@/guides/installation/_index.md#from-the-public-opam-repository) or [build from source](@/guides/installation/_index.md#build-from-sources).
...
> **Note:** Only bypass these warnings after verifying the binary's provenance.

## See Also

- [Binary Distribution](@/explanation/binary-distribution.md) - Design decisions behind our crs binaries distribution
- [Setup crs for GitHub Actions](@/guides/installation/setup-crs-for-github-actions.md)
