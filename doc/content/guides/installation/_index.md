...
- Pre-compiled binaries from GitHub releases (see [Pre-compiled Binaries](@/guides/installation/pre-compiled-binaries.md))
...
- GitHub Actions (see [Setup crs for GitHub Actions](@/guides/installation/setup-crs-for-github-actions.md))

Releases are currently versioned using the scheme `0.0.YYYYMMDD` while we are in the early stages of development.

## Pre-compiled Binaries

Pre-compiled binaries are available for select architectures from GitHub releases. This is the fastest installation method if your architecture is supported. See [Pre-compiled Binaries](@/guides/installation/pre-compiled-binaries.md) for download and verification instructions.
...
If you're looking to install crs within a GitHub Actions workflow, please see [Setup crs for GitHub Actions](@/guides/installation/setup-crs-for-github-actions.md) for the recommended approach using the `setup-crs` action.
