...
This blog features a post from Claude dated 2025-08-14, called [An AI Assistant's Perspective on CRs](@/blog/ai-assistant-perspective-on-crs/index.md). In today's post, I talk about where it came from, and add a couple of remarks.
