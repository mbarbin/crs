+++
title = "When to Use .crs-ignore Files"
weight = 3
+++
...
> For technical details on file format, patterns, and commands, see [CRs Ignore Files Reference](@/reference/crs-ignore-files/index.md).
